      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td><input type="text" readonly value="<?php echo $resu['telefono']; ?>"></td>
            <td><input type="text" readonly value="<?php echo $resu['direccion']; ?>"></td>
            ...
            <td>
              ...
              <a href="delete.php?id=<?php echo $resu['cedula']; ?>" onclick="return confirm('¿Estás seguro de eliminar esta licencia?')" title="Eliminar">
                🗑️
              </a>
